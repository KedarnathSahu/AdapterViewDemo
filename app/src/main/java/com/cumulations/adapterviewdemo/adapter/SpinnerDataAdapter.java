...
public class SpinnerDataAdapter extends BaseAdapter {
    ...
    public SpinnerDataAdapter(Context applicationContext, ArrayList<String> names, ArrayList<String> teams, ArrayList<String> imageurls) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //NEVER DO THIS (cz spinner won't open)! Solution: setOnItemSelectedListener outside of adapter(i.e, in SpinnerController Class).
